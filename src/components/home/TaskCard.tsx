  ...
  return (
    <>
      ...
      <div
        ...
        {...attributes}
        style={style}
        className={`touch-pan-y select-none bg-white rounded-xl sm:rounded-2xl p-3 sm:p-5 border border-slate-200 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer hover:-translate-y-1 ${
